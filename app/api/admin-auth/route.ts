...
export async function PUT(req: Request) {
  try {
    ...
    const updated: AdminAuth = {
      email,
      password: newPassword || oldAuth.password,
      recoveryEmail: recoveryEmail || oldAuth.recoveryEmail,
      recoveryPhone,
      recoveryCode: recoveryCode || oldAuth.recoveryCode,
    };
